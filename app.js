...
const GlowCard = ({ children, className = '', variant = 'silver' }) => {
  const gradients = {
    silver: 'from-slate-100 via-gray-300 to-slate-200',
    blue: 'from-slate-300 via-slate-400 to-slate-500',
    green: 'from-slate-200 via-gray-300 to-slate-200',
    graphite: 'from-slate-700 via-slate-800 to-slate-900',
  };

  const gradientClass = gradients[variant] || gradients.silver;
  ...
  return (
    <div className="group relative" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
      ...
      <div
        ref={cardRef}
        style={tiltStyle}
        className={`relative rounded-[1.65rem] border border-white/10 bg-gradient-to-br from-black/85 via-slate-900/75 to-slate-800/65 text-slate-100 shadow-[0_20px_60px_-25px_rgba(0,0,0,0.85)] transition-all duration-300 ${className}`}
      >
...
const AmbientBackdrop = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black relative overflow-hidden text-slate-100">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-slate-200/15 via-slate-500/10 to-transparent rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-slate-500/15 via-gray-500/10 to-transparent rounded-full blur-3xl animate-pulse delay-1000"></div>
            ...
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="bg-gradient-to-r from-slate-100 via-gray-300 to-slate-200 p-2.5 rounded-2xl shadow-lg">
                    <Video className="text-slate-900" size={26} />
                  </div>
                  <Sparkles className="absolute -top-2 -right-2 text-slate-200 animate-softPulse" size={18} />
                </div>
                <div>
                  <span className="text-2xl font-bold gradient-text tracking-tight block">Video AI Command Center</span>
                  <p className="text-sm text-white/60">Craft cinematic, data-driven experiences for every lead.</p>
                </div>
              </div>
...
const LoginPage = ({ onLogin, loading }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black relative overflow-hidden flex items-center justify-center p-6">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-slate-200/15 via-slate-500/10 to-transparent rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-slate-400/15 via-gray-500/10 to-transparent rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>

      <div className="relative z-10 w-full max-w-md">
        <GlowCard className="p-10 space-y-8" variant="blue">
          <div className="text-center space-y-4">
            <div className="mx-auto w-16 h-16 bg-gradient-to-r from-slate-100 via-gray-300 to-slate-200 rounded-2xl flex items-center justify-center shadow-xl">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2 text-left">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/30 bg-white/80 px-4 py-3 text-gray-800 shadow-inner focus:ring-2 focus:ring-slate-200 focus:border-transparent placeholder-gray-400"
              />
            </div>
...
const DashboardPage = ({ user, interactions }) => {
  const StatCard = ({ icon: Icon, label, value, color }) => {
    const iconClasses = {
      blue: 'bg-gradient-to-br from-slate-800/80 to-slate-600/60 text-slate-200',
      green: 'bg-gradient-to-br from-slate-800/80 to-slate-600/60 text-slate-200',
      purple: 'bg-gradient-to-br from-slate-800/80 to-slate-600/60 text-slate-200',
      orange: 'bg-gradient-to-br from-slate-800/80 to-slate-600/60 text-slate-200',
    };
    ...
    const accentGradients = {
      blue: 'from-slate-100 via-gray-300 to-slate-500',
      green: 'from-slate-100 via-gray-300 to-slate-500',
      purple: 'from-slate-100 via-gray-300 to-slate-500',
      orange: 'from-slate-100 via-gray-300 to-slate-500',
    };
    ...
    return (
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-black/80 via-slate-900/75 to-slate-800/60 p-6 shadow-[0_20px_60px_-40px_rgba(0,0,0,0.95)] hover:shadow-[0_28px_80px_-40px_rgba(148,163,184,0.35)] transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="w-24 h-24 rounded-full border border-white/10 bg-white/5 flex items-center justify-center">
            <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${accentGradients[color]} flex items-center justify-center text-slate-900 font-semibold text-lg`}>↗</div>
          </div>
        </div>
        <div className="mt-4">
        ...
        {interactions.length === 0 ? (
          ...
          <div className="space-y-4">
            {interactions.map((interaction, idx) => (
              <div
                key={idx}
                className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-4 flex items-center justify-between transition-all duration-300 hover:-translate-y-1 hover:border-slate-200/30"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-slate-300/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                <div className="relative flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-slate-800/50 text-slate-100 flex items-center justify-center">
                    <Video size={22} />
                  </div>
                  <div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-white placeholder-white/40 focus:ring-2 focus:ring-slate-200/70 focus:border-transparent"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className="block border-2 border-dashed border-white/10 rounded-2xl p-8 text-center cursor-pointer hover:border-slate-200/60 hover:bg-white/10 transition-all duration-300 group"
                  >
                    <Upload
                      className="mx-auto mb-3 text-white/40 group-hover:text-slate-200 group-hover:scale-110 transition-all duration-300"
                      size={48}
                    />
                    <p className="text-white/70 group-hover:text-slate-100 font-medium">
            ...
            <div className="space-y-5">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="rounded-xl border border-white/15 bg-white/10 p-4 text-white/70">
      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-start justify-center p-4 sm:p-8 overflow-y-auto animate-fadeIn">
        <div className="relative bg-gradient-to-br from-slate-950/95 via-slate-900/95 to-slate-900/90 text-slate-100 rounded-3xl p-8 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.9)] max-w-lg w-full animate-slideUp max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              {steps.map((item) => (
                <div key={item.id} className={`flex-1 h-2 rounded-full ${step >= item.id ? 'bg-gradient-to-r from-slate-200 to-slate-400' : 'bg-white/10'}`}></div>
              ))}
            </div>
    ...
    <div className="space-y-8">
      ...
      {salespeople.length === 0 ? (
        <GlowCard className="p-12 text-center space-y-4">
          <div className="mx-auto w-20 h-20 rounded-3xl bg-gradient-to-br from-slate-800/60 to-slate-600/40 flex items-center justify-center text-slate-200">
            <Users size={40} />
          </div>
          <p className="text-white/60">
        ...
        case 3:
          return (
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-white/15 bg-white/10 p-4 text-white/70 flex items-center justify-between">
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-white focus:ring-2 focus:ring-slate-200/70 focus:border-transparent"
              >
